...
function generateTOC(sections: ReportSection[]): TOCItem[] {
  ...
  sections.forEach((section, index) => {
    const level = section.title.startsWith("##")
      ? 2
        ...
        {[1, 2, 3, 4].map((level) => (
          <polygon
            ...
            points={data.labels
              .map((_, i) => {
                const angle =
                  (Math.PI * 2 * i) / data.labels.length - Math.PI / 2;
      ...
      {toc.map((item) => (
        <li
          ...
          style={{
            ...
            cursor: "pointer",
            backgroundColor:
              currentPage === item.page ? "#3498db" : "transparent",
          ...
          >
            ...
            <button
              ...
              style={{
                padding: "10px 20px",
                backgroundColor:
                  currentPage === totalPages ? "#ecf0f1" : "#3498db",
                border: "none",
                borderRadius: "4px",
