            ...
            <View key={tier.tier} className="tier-item">
              ...
              <View className="tier-benefits">
                <Text className="benefit-item">
                  📄 基础报告：
                  {tier.benefits.report_basic === "unlimited"
                    ? "无限"
                    : tier.benefits.report_basic}
                  次
                </Text>
                <Text className="benefit-item">
                  📊 专业报告：
                  {tier.benefits.report_pro === "unlimited"
                    ? "无限"
                    : tier.benefits.report_pro}
                  次
                </Text>
                <Text className="benefit-item">
                  🎉 生活事件：
                  {tier.benefits.life_event === "unlimited"
                    ? "无限"
                    : tier.benefits.life_event}
                  次
                </Text>
                <Text className="benefit-item">
                  👥 双人合测：
                  {tier.benefits.dual_test === "unlimited"
                    ? "无限"
                    : tier.benefits.dual_test}
                  次
                </Text>
              ...
              >
                {currentMembership?.tier === tier.tier
                  ? "当前套餐"
                  : "立即升级"}
              </Button>
            </View>
