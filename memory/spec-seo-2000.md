    ...
    <div class="product">
      ...
      <div class="product-info">
        ...
        <div class="description">
          ...
          battery life, and Hi-Res audio support.
        </div>
        <div class="options">
...
<html lang="en">
  <head>
    ...
    <title>
      Wireless Headphones Pro Max - Active Noise Cancelling | MyShop
    </title>
    <meta
      name="description"
      content="Premium wireless headphones with active noise cancellation, 30-hour battery life, and Hi-Res audio. Rated 4.5/5 stars. Free shipping on orders over $50."
    />
    <meta name="robots" content="index, follow, max-image-preview:large" />
    <link
      rel="canonical"
      href="https://www.myshop.com/products/wireless-headphones-pro-max"
    />
    ...
    <meta
      property="og:title"
      content="Wireless Headphones Pro Max - Active Noise Cancelling"
    />
    <meta
      property="og:description"
      content="Premium wireless headphones with active noise cancellation, 30-hour battery life, and Hi-Res audio."
    />
    <meta
      property="og:image"
      content="https://www.myshop.com/images/products/headphones-pro-max-og.jpg"
    />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta
      property="og:url"
      content="https://www.myshop.com/products/wireless-headphones-pro-max"
    />
    ...
    <meta
      ...
      content="Premium wireless headphones with active noise cancellation, 30-hour battery life."
    />
    <meta
      name="twitter:image"
      content="https://www.myshop.com/images/products/headphones-pro-max-twitter.jpg"
    />
    ...
    <link
      rel="alternate"
      hreflang="zh"
      href="https://www.myshop.com/zh/products/wireless-headphones-pro-max"
    />
    <link
      rel="alternate"
      hreflang="x-default"
      ...
      <nav aria-label="Main navigation">
        ...
        >
          ...
          <span id="search-help" class="sr-only"
            >Enter product name or keywords</span
          >
    ...
    <main id="main-content">
        ...
        <section aria-label="Product images">
          ...
          >
            ...
            <figcaption itemprop="description">
              Wireless Headphones Pro Max - Black
            </figcaption>
          </figure>
          <!-- Thumbnail gallery -->
          <div
          ...
          >
            <button
              type="button"
              role="listitem"
              aria-label="View black color"
              aria-current="true"
              class="thumb active"
            >
              <img
                src="headphones-black-thumb.jpg"
                alt=""
                width="80"
                height="80"
                loading="lazy"
            ...
            <button type="button" role="listitem" aria-label="View white color">
              <img
                src="headphones-white-thumb.jpg"
                alt=""
                width="80"
                height="80"
                loading="lazy"
        ...
        <section aria-label="Product details">
          ...
          <div itemprop="offers" itemscope itemtype="https://schema.org/Offer">
            ...
            <p class="price">
              ...
              <span class="discount-badge" aria-label="25 percent off"
                >Save 25%</span
              >
            </p>
          </div>
          ...
          <div itemprop="description" class="product-description">
            <p>
              ...
              <strong>30-hour battery life</strong>, and
              <strong>Hi-Res audio</strong> support.
            </p>
            <ul>
          ...
          <div class="quantity-selector">
            ...
            <div class="qty-controls">
              ...
              <span id="qty-help" class="sr-only"
                >Maximum 10 items per order</span
              >
          ...
          <div class="product-actions">
            <form action="/cart/add" method="post">
              ...
              <button
                type="submit"
                class="btn-primary"
                aria-label="Add Wireless Headphones Pro Max to cart"
              >
                Add to Cart — $299.99
              </button>
            </form>
      ...
      <section id="reviews" aria-labelledby="reviews-heading">
        ...
        >
          ...
          <time itemprop="datePublished" datetime="2026-04-15"
            >April 15, 2026</time
          >
        </article>
        ...
        >
          ...
          <time itemprop="datePublished" datetime="2026-04-10"
            >April 10, 2026</time
          >
        </article>
      </section>
...
const qtyMinus = qtyInput.parentElement.querySelector(
  '[aria-label="Decrease quantity"]',
);
const qtyPlus = qtyInput.parentElement.querySelector(
...
<picture>
  <source
    srcset="headphones-black.webp 800w, headphones-black.webp 1200w"
    type="image/webp"
    sizes="(max-width: 768px) 400px, 800px"
  />
  <source
    srcset="headphones-black.jpg 800w, headphones-black.jpg 1200w"
    type="image/jpeg"
    sizes="(max-width: 768px) 400px, 800px"
  />
  <img
