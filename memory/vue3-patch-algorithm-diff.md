...
<!-- 编译后（伪代码） -->
const _hoisted_1 = createVNode("h1", null, "静态标题", -1 /* HOISTED */) const
_hoisted_2 = createVNode("p", { class: "static" }, "静态段落", -1 /* HOISTED */)
return (openBlock(), createBlock("div", null, [ _hoisted_1, _hoisted_2,
createVNode("span", { class: dynamicClass }, toDisplayString(count), 9 /* TEXT +
CLASS */, ["class"]) ], 64 /* STABLE_FRAGMENT */))
```
...
```typescript
function setFullProps(el: Element, props: VNodeProps, vnode: VNode) {
...
<!-- 编译后 -->
const _hoisted_1 = createVNode("h1", null, "静态标题", -1) const _hoisted_2 =
createVNode("span", { class: cls }, "静态文本", 2 /* CLASS */) return
(openBlock(), createBlock("div", null, [ _hoisted_1, // 静态 → 不在
dynamicChildren 中 createVNode("p", null, toDisplayString(dynamicText), 1 /*
TEXT */), _hoisted_2 ], 64 /* STABLE_FRAGMENT */)) // dynamicChildren = [p
vnode, span vnode] // 只有动态节点！ // h1 被 hoistStatic
提升到编译时，运行时不参与 diff
```
...
const patchProps = (
  ...
  for (const key in newProps) {
    ...
    if (next !== prev) {
      hostPatchProp(el, key, prev, next, isSVG, vnode as VNode<Node, Element>);
    }
  }
...
_精读完成于 2026-05-05 04:00 AM_
_下次精读方向：Vue 3 Scheduler 调度系统与 React Concurrent Mode 对比_
