...
type AllCombinations2<Letters extends string, Acc extends string = ""> = [
  ...
  : Letters extends string
    ? AllCombinations2<
        Exclude<Letters, Letters>,
        Acc | `${Acc}${Letters}` | Letters
      >
    : never;

// Correct approach: for each letter in the union, generate combinations
// This generates permutations of the input letters
type AllCombinationsCorrect<Letters extends string> = Letters extends Letters
...
type Test6 = Expect<
  Equal<
    ReplaceKeys<Test6Input, "name" | "age", string>,
...
// ============================================
type DropLast<T extends readonly any[]> = T extends readonly [
  ...infer Rest,
  any,
]
  ? Rest
...
type Test12_3 = Expect<
  Equal<PromiseChain<Promise<Promise<Promise<boolean>>>>, boolean>
>;
...
type Test14 = Expect<
  Equal<
    AddPrefixToKeys<"pre_", { a: number; b: string }>,
    { pre_a: number; pre_b: string }
  >
>;
...
// ============================================
type Filter<T extends readonly any[], U> = T extends readonly [
  infer F,
  ...infer Rest,
]
  ? F extends U
...
// [1, 2, 3] 移除 2 → [1, 3]
// ============================================
type Without<T extends readonly any[], U> = T extends readonly [
  infer F,
  ...infer Rest,
]
  ? Equal<F, U> extends true
...
// ['a', 'b', 'c'] + '-' → 'a-b-c'
// ============================================
type Join<T extends readonly any[], D extends string> = T extends readonly [
  infer F,
  ...infer Rest,
]
...
type Test21 = Expect<
  Equal<AppendToObj<{ a: number }, "b", string>, { a: number; b: string }>
>;
...
// [1, 2, 3] 和 [2, 3, 4] → [1, 4]
// ============================================
type Includes2<T extends readonly any[], V> = T extends readonly [
  infer F,
  ...infer Rest,
]
...
type Test24 = Expect<
  Equal<CapitalizeWords<"hello world foo">, "Hello World Foo">
>;
