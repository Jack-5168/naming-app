...
export function trigger(
  ...
  const run = (dep: Dep | undefined) => { if (dep) dep.trigger() }
...
class RefImpl<T = any> {
  ...
  set value(newValue) {
    ...
    const useDirectValue = this[IS_SHALLOW] || isShallow(newValue) || isReadonly(newValue)
...
*分析完成时间: 2026-05-01 04:00*
*源码来源: https://github.com/vuejs/core (main 分支)*
