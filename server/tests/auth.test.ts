...
describe('Auth Security Module - Device Fingerprint', () => {
  describe('Device Fingerprint', () => {
    ...
    it('should generate different fingerprints for different User-Agents', () => {
      ...
      const fp1 = auth.generateDeviceFingerprint('Mozilla/5.0 Browser A', ip, {});
      const fp2 = auth.generateDeviceFingerprint('Mozilla/5.0 Browser B', ip, {});
    ...
    it('should incorporate headers into fingerprint', () => {
      ...
      const fp1 = auth.generateDeviceFingerprint(ua, ip, { 'Accept-Language': 'en-US' });
      const fp2 = auth.generateDeviceFingerprint(ua, ip, { 'Accept-Language': 'zh-CN' });
