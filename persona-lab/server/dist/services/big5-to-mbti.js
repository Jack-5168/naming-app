...
exports.mapBig5ToMBTI = mapBig5ToMBTI;
exports.getDimensionDescription = getDimensionDescription;
exports.getTypeExplanation = getTypeExplanation;
exports.calculateTypeSimilarity = calculateTypeSimilarity;
/**
 * MBTI 类型描述数据库
 */
 ...
 */
function mapBig5ToMBTI(O, // 开放性 0-100
C, // 尽责性 0-100
E, // 外向性 0-100
A, // 宜人性 0-100
N // 神经质 0-100
 ...
 * 映射单个维度
 */
function mapDimension(score, threshold) {
 ...
 * 获取高分端极性标签
 */
function getHighPolarity(score) {
...
exports.default = mapBig5ToMBTI;
//# sourceMappingURL=big5-to-mbti.js.map