...
exports.wechatPaymentCallback = wechatPaymentCallback;
 ...
 */
async function wechatPaymentCallback(req, res) {
    try {
      ...
      `);
        ...
        const { out_trade_no, // Our order number
 ...
 */
function parseWechatCallbackXml(xmlData) {
 ...
 */
function verifyWechatSignature(data) {
 ...
 */
async function activateMembershipBenefits(order) {
