...
const QUESTIONS = [
  // Openness (O) - 5 questions
  {
    id: 1,
    dim: 'O',
    text: '我喜欢尝试 new experiences',
    opts: [
      { t: 'Strongly agree', v: 3 },
      { t: 'Agree', v: 2 },
      { t: 'Neutral', v: 1 },
      { t: 'Disagree', v: 0 },
      { t: 'Strongly disagree', v: -1 },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    id: 13,
    dim: 'E',
    text: 'I enjoy being around people',
    opts: [
      { t: 'Strongly agree', v: 3 },
      { t: 'Agree', v: 2 },
      { t: 'Neutral', v: 1 },
  ...
  },
  {
    id: 15,
    dim: 'E',
    text: 'I am energetic around others',
    opts: [
      { t: 'Strongly agree', v: 3 },
      { t: 'Agree', v: 2 },
      { t: 'Neutral', v: 1 },
  ...
  },
  {
    id: 23,
    dim: 'N',
    text: 'I am emotionally stable (inverse)',
    opts: [
      { t: 'Strongly agree', v: -1 },
      { t: 'Agree', v: 0 },
      { t: 'Neutral', v: 1 },
      { t: 'Disagree', v: 2 },
      { t: 'Strongly disagree', v: 3 },
    ],
  },
  {
    id: 24,
    dim: 'N',
    text: 'I remain calm under pressure (inverse)',
    opts: [
      { t: 'Strongly agree', v: -1 },
      { t: 'Agree', v: 0 },
      { t: 'Neutral', v: 1 },
  ...
  try {
    ...
    if (session.state === 'completed') {
      return res.json({
        ...
        result: { mbti: calculateResult(session) },
      });
    }
    ...
    res.json({
      question: {
        ...
        text: q.text,
        dim: q.dim,
        opts: q.opts.map((o) => ({ id: v16_encode(o.t), text: o.t })),
      },
...
app.post('/sessions/:id/answer', async (req, res) => {
  try {
    ...
    const qIdx = QUESTIONS.findIndex(
      (q) => q.id === (questionId || session.currentQuestion + 1),
    );
    const q = QUESTIONS[qIdx];
    ...
    if (cur >= 25) {
      ...
      return res.json({
        ...
        result: { mbti: calculateResult({ answers }) },
      });
    }
    ...
    res.json({
      question: {
        ...
        text: nextQ.text,
        dim: nextQ.dim,
        opts: nextQ.opts.map((o) => ({ id: v16_encode(o.t), text: o.t })),
      },
